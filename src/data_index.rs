...
impl ChannelLayout {
    ...
    pub fn new(
        ...
        Self {
            ...
            byte_size: ((bit_offset as u32 + bit_count + 7) / 8) as usize,
            bit_offset,
            bit_count,
            is_signed,
            is_float,
...
mod tests {
    ...
    fn test_data_block_type() {
        ...
        assert_eq!(DataBlockType::from_bytes(b"SD"), Some(DataBlockType::SortedData));
        assert_eq!(DataBlockType::from_bytes(b"DZ"), Some(DataBlockType::Compressed));
