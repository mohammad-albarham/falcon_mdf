...
#   2. Three files from asammdf's own test resources, two of which were written
#      by third-party tools (TGT 15.0 and dax3.0.0).
#
...
ASAMMDF_FILES=(ASAP2_Demo_V171.mf4 test_batch.mf4 test_metadata.mf4)
