...
fn test_version_is_supported() {
    ...
    let unknown = Mf4Version::Unknown { major: 9, minor: 99, raw: 999 };
...
fn test_version_parts() {
    ...
    let unknown = Mf4Version::Unknown { major: 5, minor: 0, raw: 500 };
...
fn test_version_display() {
    ...
    assert_eq!(format!("{}", Mf4Version::Unknown { major: 5, minor: 0, raw: 500 }), "5.0");
}
...
fn test_version_validate() {
    ...
    let unknown = Mf4Version::Unknown { major: 9, minor: 0, raw: 900 };
